...
**(New)** - **Research Orchestration (Nebius UDR prototype)**: FastAPI backend + Next.js frontend configurable strategies for deep research; integrates via OpenAI-compatible Nebius API and Tavily search (experimental; non-production).
